-- =============================================
-- ThaMu Viajando — 003: Admin-only guards
...
CREATE OR REPLACE FUNCTION thamu_viajando_is_admin()
RETURNS BOOLEAN
SECURITY DEFINER
...
GRANT EXECUTE ON FUNCTION thamu_viajando_is_admin() TO authenticated;
...
--
-- DROP FUNCTION IF EXISTS thamu_viajando_is_admin();
--
-- DROP FUNCTION IF EXISTS thamu_viajando_admin_list_users();
-- CREATE OR REPLACE FUNCTION thamu_viajando_admin_list_users()
-- RETURNS TABLE(
